...
class ThreatIntelActivity:
    ...
    def run(self) -> bool:
        ...
        mr_iid  = self.author.create_mr(
            ...
            "Источник: TI-фид. Индикаторы смаппены на правила C2/exfiltration.\n\n"
            "- [x] IOC провалидированы (не пересекаются с легитимной инфрой)\n"
            "- [ ] Blocklist синхронизирован с proxy",
            lead_id,
        )
        if not mr_iid:
            return False
