...
def main():
    ...
    print("  действительно ослепляет сигнатурный слой.")
    if gain > 0.10:
        print("  Поведенческий слой компенсирует потерю: доля пойманных ТОЛЬКО им")
        print(f"  растёт на {gain*100:.0f} п.п. Это то, что регуляркой не покрыть.")
    else:
        print("  Поведенческий слой компенсирует лишь малую часть "
